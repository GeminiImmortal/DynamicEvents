tellraw @a {"color":"dark_purple", "text":"The roaring thunder takes shape and attacks you!"}
title @s title ["",{"text":"Roaring Thunder","underlined":true, "color":"dark_purple"}]
title @s subtitle ["",{"text":"The roaring thunder takes shape and attacks you!", "color":"dark_red"}]
