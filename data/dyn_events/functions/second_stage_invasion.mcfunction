...
tellraw @a {"color":"dark_red", "text":"Hell's fury takes shape before your very eyes!"}
title @s title ["",{"text":"Hell's Retribution","underlined":true, "color":"dark_red"}]
title @s subtitle ["",{"text":"Hell's fury takes shape before your very eyes!", "color":"dark_red"}]
