...
tellraw @s {"color":"dark_purple", "text":"Witches are attempting to commune with hell..."}
title @s title ["",{"text":" ", "color":"dark_purple"}]
title @s subtitle ["",{"text":"Witches are attempting to commune with hell...", "color":"dark_red"}]
