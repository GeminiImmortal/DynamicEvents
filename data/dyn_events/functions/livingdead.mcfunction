tellraw @a {"color":"dark_purple", "text":"The dead walk the earth..."}
title @s title ["",{"text":"Night of the Living Dead","underlined":true, "color":"dark_purple"}]
title @s subtitle ["",{"text":"The dead walk the earth...", "color":"dark_red"}]
